	...
	grunt.initConfig({
		jshint: {
			all: [
					...
					"highlight.js/9.12.0/js/highlight.pack.js",
					...
					"polyfills/js/polyfills.fixed.min.js",
					...
					"Tocca.js/2.0.1/js/Tocca.fixed.min.js",
					...
					"wheel-indicator/1.1.4/js/wheel-indicator.fixed.min.js",
