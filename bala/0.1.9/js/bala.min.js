 ...
 */
var forEach=function(a,b,c){var d=-1,e=a.length>>>0;(function f(g){var h,j=!1===g;do++d;while(!(d in a)&&d!==e);if(j||d===e){if(c){c(!j,a);}return;}g=b.call({async:function(){return h=!0,f;}},a[d],d,a);if(!h){f(g);}})();};
/*!
