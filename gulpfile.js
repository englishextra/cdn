...
var options = {
	libbundle: {
		src: [
			...
			"./libs/img-lightbox/0.2.3/src/img-lightbox.fixed.js",
			...
			"./libs/jquery/3.1.1/js/jquery.fixed.js",
			...
			"./libs/qrjs2/0.1.7/src/qrjs2.fixed.js",
			...
			"./libs/sw-toolbox/3.6.1/js/companion.fixed.js",
			"./libs/sw-toolbox/3.6.1/js/sw-toolbox.fixed.js",
