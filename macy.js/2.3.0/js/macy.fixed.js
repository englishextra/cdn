	...
	(this, function () {
		...
		function h(t, n) {
			...
			m(n, function (n) {
				...
				isNaN(e) || (n.style.position = "absolute", n.style.top = t.rows[t.lastcol] + "px", n.style.left = "" + t.cols[t.lastcol], t.rows[t.lastcol] += isNaN(e) ? 0 : e + i, t.lastcol += 1, o && (n.dataset.macyComplete = 1));
			}),
			o && (t.tmpRows = null),
			l(t);
		}
		var f = function t(n, e) {
			...
			for (var o in this.selectors) {
				if (e = o.split("/"), new RegExp(e[1], e[2]).test(n)) {
					return this.selectors[o](n);
				}
			}
			return this.byCss(n);
		};
		...
		C = function (t, n) {
			...
			if (t.lastcol || (t.lastcol = 0), t.rows.length < 1 && (e = !0), e) {
				...
				t.rows = [];
				for (var o1 = n - 1; o1 >= 0; o1--) {
					t.rows[o1] = t.tmpRows[o1];
				}
			} else {
				t.tmpRows = [];
				for (var o2 = n - 1; o2 >= 0; o2--) {
					t.tmpRows[o2] = t.rows[o2];
				}
			}
		},
		V = function (t) {
					...
					function t(t) {
						return function (e) {
							if (e && n.test(e)) {
								...
								return null === o ? this.removeAttribute("id") : o || (this.id = o),
								r;
							}
