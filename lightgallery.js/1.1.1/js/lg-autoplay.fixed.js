		...
		1: [function (require, module, exports) {
			(function (global, factory) {
				...
				Autoplay.prototype.init = function () {
					...
					if (_this.core.s.progressBar) {
						_this.core.outer.querySelector('.lg')
							.insertAdjacentHTML('beforeend', '<div class="lg-progress-bar"><div class="lg-progress"></div></div>');
					} // set progress
				...
				Autoplay.prototype.controls = function () {
					...
					_this.core.outer.querySelector(this.core.s.appendAutoplayControlsTo)
				...
				Autoplay.prototype.destroy = function () {
					...
					if (this.core.outer.querySelector('.lg-progress-bar')) {
						this.core.outer.querySelector('.lg-progress-bar')
							.parentNode.removeChild(this.core.outer.querySelector('.lg-progress-bar'));
					}
				};
