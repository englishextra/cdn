...
/*!
 * javascript, xml, css, scss
 * @see {@link https://highlightjs.org/download/}
 */
...
(function (root) {
	...
	root.hljs.registerLanguage("xml", function (s) {
		var e = "[A-Za-z0-9\\._:-]+",
			t = {
				eW: !0,
				i: /</,
	...
	root.hljs.registerLanguage("css", function (e) {
	...
	root.hljs.registerLanguage("javascript", function (e) {
	...
	root.hljs.registerLanguage("scss", function (e) {
...
})("object" == (typeof window === "undefined" ? "undefined" : _typeof(window)) && window || "object" == (typeof self === "undefined" ? "undefined" : _typeof(self)) && self);
/* jshint expr: false */
